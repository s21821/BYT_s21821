...
public class Money implements Comparable {
	...
	public String toString() {
		return "" + amount * 0.01 + " " + currency.getName();
	}
	...
	public Money add(Money other) {
		int newMoney = this.getAmount()+other.getCurrency().valueInThisCurrency(other.getAmount(),other.getCurrency());
		return new Money(newMoney, this.getCurrency());
	}
	...
	public int compareTo(Object other) {
		Money otherOther = (Money) other;
		int first = this.universalValue();
		int second = otherOther.universalValue();
