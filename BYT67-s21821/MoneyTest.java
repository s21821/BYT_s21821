...
public class MoneyTest {
	...
	public void testToString() {
		Assert.assertEquals("Test: String to value 0 EUR", "0.0 EUR", EUR0.toString());
		Assert.assertEquals("Test: String to value 10 EUR", "10.0 EUR", EUR10.toString());
	}
	...
	@Test
	public void testAdd() {
		Assert.assertEquals("Test: Adding SEK + SEK", "200.0 SEK", SEK100.add(SEK100).toString());
		Assert.assertEquals("Test: Adding SEK + EUR", "110.0 SEK", SEK100.add(EUR10).toString());
	}

	@Test
	public void testSub() {
		Assert.assertEquals("Test: Subtraction currencies below zero", "-100.0 SEK", SEK100.sub(SEK200).toString());
		Assert.assertEquals("Test: Subtraction currencies above zero", "0.0 SEK", SEK100.sub(SEK100).toString());
	}
	...
	public void testNegate() {
		Assert.assertEquals("Test: Negation of money ", "-100.0 SEK", SEK100.negate().toString());
	}
